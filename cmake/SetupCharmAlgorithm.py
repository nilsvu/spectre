...
def create_interface_file(args):
    ...
    if args['algorithm_type'] == 'array':
        ci_str += "  template <typename SectionProxy, typename TargetProxy, typename DataType> message SectionReductionMessage;\n"
    ...
    if args['algorithm_type'] == 'array':
        ci_str += "    template <typename ContributeToReduction, typename SectionProxy, typename TargetProxy, typename DataType> entry void contribute_to_section_reduction(SectionReductionMessage<SectionProxy, TargetProxy, DataType>* msg);\n"
