...
if(CHARM_VERSION_FILE_VERSION STREQUAL "6_11")
  ...
  message(FATAL_ERROR "Charm 6.11+ is not yet supported")
...
#   between static and shared libs builds than just passing on the "-L" and "-l"
#   flags. Instead of parsing the list of libs we could just hard-code lib
#   names, but that may break with future Charm versions and could be annoying
#   to debug. However, it would give us more control over which libs to link.
#   Ideally, Charm++ would provide exported targets with these libs.
...
# Invoke `charmc` to generate definitions for the module-init functions. The
# interface for this could be improved on the Charm++ side. See this upstream
# issue: https://github.com/UIUC-PPL/charm/issues/3210
...
# - Target just for the PUP serialization library. We just make it an alias for
#   now, but could restrict it to contain only the PUP libs.
