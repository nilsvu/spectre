      ...
      for (const bool excise_interiorB : {true, false}) {
        ...
        for (const bool use_logarithmic_map_outer_spherical_shell :
          ...
          std::vector<std::string> expected_block_names{
              ...
              "EnvelopingCubeLeftUpperZ",  "EnvelopingCubeRightUpperZ",
              "EnvelopingCubeLeftLowerZ",  "EnvelopingCubeRightLowerZ",
              "EnvelopingCubeLeftUpperY",  "EnvelopingCubeRightUpperY",
              "EnvelopingCubeLeftLowerY",  "EnvelopingCubeRightLowerY",
              "EnvelopingCubeRightUpperX", "EnvelopingCubeLeftLowerX",
              "CubedShellLeftUpperZ",      "CubedShellRightUpperZ",
              "CubedShellLeftLowerZ",      "CubedShellRightLowerZ",
              "CubedShellLeftUpperY",      "CubedShellRightUpperY",
              "CubedShellLeftLowerY",      "CubedShellRightLowerY",
              "CubedShellRightUpperX",     "CubedShellLeftLowerX",
              "OuterShellLeftUpperZ",      "OuterShellRightUpperZ",
              "OuterShellLeftLowerZ",      "OuterShellRightLowerZ",
              "OuterShellLeftUpperY",      "OuterShellRightUpperY",
              "OuterShellLeftLowerY",      "OuterShellRightLowerY",
              "OuterShellRightUpperX",     "OuterShellLeftLowerX"};
          std::unordered_map<std::string, std::unordered_set<std::string>>
              expected_block_groups{
                  ...
                  {"EnvelopingCube",
                   {"EnvelopingCubeRightUpperZ", "EnvelopingCubeRightUpperX",
                    "EnvelopingCubeLeftLowerZ", "EnvelopingCubeRightLowerZ",
                    "EnvelopingCubeRightUpperY", "EnvelopingCubeRightLowerY",
                    "EnvelopingCubeLeftUpperY", "EnvelopingCubeLeftUpperZ",
                    "EnvelopingCubeLeftLowerY", "EnvelopingCubeLeftLowerX"}},
                  {"CubedShell",
                   {"CubedShellLeftUpperZ", "CubedShellRightUpperZ",
                    "CubedShellLeftLowerZ", "CubedShellRightLowerZ",
                    "CubedShellLeftUpperY", "CubedShellRightUpperY",
