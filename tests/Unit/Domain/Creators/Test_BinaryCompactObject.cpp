        ...
        for (const bool use_logarithmic_map_outer_spherical_shell :
          ...
          const domain::creators::BinaryCompactObject binary_compact_object{
              domain::creators::BinaryCompactObject::Object{
                  ...
                  excise_interiorA ? std::make_optional(
              ...
              domain::creators::BinaryCompactObject::Object{
                  ...
                  excise_interiorB ? std::make_optional(
                                         with_boundary_conditions
                                             ? create_inner_boundary_condition()
                                             : nullptr)
                                   : std::nullopt,
              ...
              CHECK_THROWS_WITH(
                  domain::creators::BinaryCompactObject(
                      domain::creators::BinaryCompactObject::Object{
                          ...
                          excise_interiorA
                              ? std::make_optional(
                                    std::unique_ptr<domain::BoundaryConditions::
                                                        BoundaryCondition>{
                                        nullptr})
                              : std::nullopt,
                          false, 0},
...
std::string create_option_string(const bool excise_A, const bool excise_B,
  ...
  const std::string interior_A{
      add_boundary_condition
          ? std::string{"    Interior:\n" +
                        std::string{excise_A ? "      TestBoundaryCondition:\n"
  ...
  const std::string interior_B{
      add_boundary_condition
          ? std::string{"    Interior:\n" +
                        std::string{excise_B ? "      TestBoundaryCondition:\n"
                                               "        Direction: lower-zeta\n"
                                               "        BlockId: 50\n"
                                             : "      Auto\n"}}
...
void test_parse_errors() {
  CHECK_THROWS_WITH(
      domain::creators::BinaryCompactObject(
          ...
          {0.3, 1.0, 1.0, create_inner_boundary_condition(), false, 0}, 25.5,
          32.4, 2, 6, true, false, 0, nullptr,
  ...
  CHECK_THROWS_WITH(
      domain::creators::BinaryCompactObject(
          ...
          {0.3, 1.0, 8.0, create_inner_boundary_condition(), false, 0}, 25.5,
          32.4, 2, 6, true, false, 0, nullptr,
          create_outer_boundary_condition(), Options::Context{false, {}, 1, 1}),
  ...
  CHECK_THROWS_WITH(
      domain::creators::BinaryCompactObject(
          {0.5, 1.0, -1.0, create_inner_boundary_condition(), false, 0},
          {3.3, 1.0, 1.0, create_inner_boundary_condition(), false, 0}, 25.5,
          32.4, 2, 6, true, false, 0, nullptr,
          create_outer_boundary_condition(), Options::Context{false, {}, 1, 1}),
      Catch::Matchers::Contains(
