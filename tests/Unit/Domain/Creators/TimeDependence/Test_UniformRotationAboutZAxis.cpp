...
void test_equivalence() noexcept {
  {
    UniformRotationAboutZAxis<1> ur0{1.0, 2.0, "RotationAnglePhi"};
    UniformRotationAboutZAxis<1> ur1{1.2, 2.0, "RotationAnglePhi"};
    UniformRotationAboutZAxis<1> ur2{1.0, 3.0, "RotationAnglePhi"};
    UniformRotationAboutZAxis<1> ur3{1.0, 2.0, "RotationAngleTheta"};
    CHECK(ur0 == ur0);
    CHECK_FALSE(ur0 != ur0);
    CHECK(ur0 != ur1);
    CHECK_FALSE(ur0 == ur1);
