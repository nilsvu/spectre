...
void test_cylinder_no_refinement() {
  ...
  const auto outer_radial_distribution =
    ...
    for (const bool equiangular_map : {true, false}) {
      ...
      for (const bool periodic_in_z : {true, false}) {
        ...
        const std::string opt_string{
            ...
            "  RadialPartitioning: []\n"
            "  HeightPartitioning: []\n"
            "  OuterRadialDistribution: Linear\n" +
            std::string{
                with_boundary_conditions
        ...
        if (with_boundary_conditions) {
          CHECK_THROWS_WITH(
              creators::Cylinder(
                  ...
                  equiangular_map, {}, {}, outer_radial_distribution,
          ...
          CHECK_THROWS_WITH(
              creators::Cylinder(
                  ...
                  outer_radial_distribution, Options::Context{false, {}, 1, 1}),
              Catch::Matchers::Contains(
