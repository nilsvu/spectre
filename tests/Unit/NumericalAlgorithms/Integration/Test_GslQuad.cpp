...

{
  ...
  /// [integration_example]
  integrate::GslQuadAdaptive<integrate::IntegralType::StandardGaussKronrod> integration{20};
  const double mean = 5.;
  ...
  auto result = integration(
      ...
      lower_bound, upper_bound, 1.e-10, 4);
  /// [integration_example]
  CHECK(result == approx(factor * erf(upper_bound - mean) -
