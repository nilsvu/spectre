  ...
  static auto apply(db::DataBox<DbTagsList>& box,
    ...
    return std::make_tuple(
        ::Initialization::merge_into_databox<
            ...
            std::move(box), typename fields_tag::type{num_points, 0.}, source));
  }
};
...
struct ComputeOperatorAction {
  ...
  static std::tuple<db::DataBox<DbTagsList>&&, bool> apply(
    ...
    auto& section = *db::get<Parallel::Tags::SectionBase<
        ::LinearSolver::multigrid::Tags::MultigridLevel>>(box);
    Parallel::contribute_to_reduction<
        CollectOperatorAction<OperandTag>, ParallelComponent,
