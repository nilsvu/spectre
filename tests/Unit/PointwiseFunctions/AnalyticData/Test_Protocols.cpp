...
/// [evolution_analytic_data_example]
test_protocol_conformance<EvolutionAnalyticData<3>,
...
/// [elliptic_analytic_data_example]
test_protocol_conformance<EllipticAnalyticData<3>,
...
static_assert(
    ...
    "Failed testing is_conforming_v");
static_assert(
    elliptic::protocols::AnalyticData::template is_conforming_v<AllSingleTags>,
    "Failed testing is_conforming_v");
