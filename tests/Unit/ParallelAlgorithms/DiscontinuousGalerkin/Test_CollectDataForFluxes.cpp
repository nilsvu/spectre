...
struct DgBoundaryScheme {
  ...
  struct boundary_data_computer {
    using argument_tags =
        tmpl::list<TemporalIdTag, domain::Tags::Mesh<FaceDim>>;
...
struct ElementArray {
  ...
  using const_global_cache_tags = tmpl::list<domain::Tags::Domain<VolumeDim>>;
      ...
      Parallel::PhaseActions<
          ...
          tmpl::list<
              ActionTesting::InitializeDataBox<db::AddSimpleTags<
                  domain::Tags::InitialExtents<VolumeDim>, TemporalIdTag,
              ...
              Initialization::Actions::AddComputeTags<tmpl::list<
                  ...
                  domain::Tags::InterfaceCompute<
                      domain::Tags::InternalDirections<VolumeDim>,
                      domain::Tags::Direction<VolumeDim>>,
                  domain::Tags::InterfaceCompute<
                      domain::Tags::BoundaryDirectionsInterior<VolumeDim>,
                      domain::Tags::Direction<VolumeDim>>,
                  domain::Tags::InterfaceCompute<
                  ...
                  domain::Tags::InterfaceCompute<
                      domain::Tags::InternalDirections<VolumeDim>,
                      domain::Tags::InterfaceMesh<VolumeDim>>,
                  domain::Tags::InterfaceCompute<
                      domain::Tags::BoundaryDirectionsInterior<VolumeDim>,
                      domain::Tags::InterfaceMesh<VolumeDim>>,
                  domain::Tags::InterfaceCompute<
...
SPECTRE_TEST_CASE("Unit.DG.Actions.CollectDataForFluxes",
  ...
  const auto check_mortar =
      [&get_tag, &time](const std::pair<Direction<VolumeDim>,
                                        ElementId<VolumeDim>>& mortar_id,
