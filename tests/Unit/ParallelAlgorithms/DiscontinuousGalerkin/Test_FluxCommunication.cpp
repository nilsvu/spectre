...
SPECTRE_TEST_CASE("Unit.DiscontinuousGalerkin.Actions.FluxCommunication",
  ...
  runner.next_action<element_array>(self_id);
  CHECK(
      tuples::get<fluxes_inbox_tag>(runner.inboxes<element_array>().at(self_id))
          .empty());
