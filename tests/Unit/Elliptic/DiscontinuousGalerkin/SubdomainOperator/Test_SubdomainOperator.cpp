...
void test_subdomain_operator_impl(
  ...
  LinearSolver::Schwarz::OverlapMap<volume_dim, Index<volume_dim>>
      all_overlap_extents{};
  ...
  for (const auto& direction_and_neighbors :
    ...
    for (const auto& neighbor_id : neighbors) {
      ...
      const auto overlap_extents = LinearSolver::Schwarz::overlap_extents(
          neighbor.mesh.extents(), overlap, dimension_in_neighbor);
      all_overlap_extents.emplace(std::make_pair(mortar_id, overlap_extents));
  ...
  using SubdomainOperator = elliptic::dg::SubdomainOperator<
      ...
      DummyOptionsGroup, FluxesArgsTagsFromCenter>;
  auto initial_box = db::create<
      db::AddSimpleTags<
          ...
          LinearSolver::Schwarz::Tags::Overlaps<
              domain::Tags::Extents<volume_dim>, volume_dim, DummyOptionsGroup>,
  ...
  using fluxes_args_internal_faces_tags = tmpl::transform<
      ...
      tmpl::bind<domain::Tags::Interface,
                 ...
                 tmpl::_1>>;
  tuple_from_typelist<tmpl::transform<fluxes_args_internal_faces_tags,
  ...
  using fluxes_args_boundary_faces_tags = tmpl::transform<
      ...
      tmpl::bind<
          ...
          tmpl::_1>>;
  tuple_from_typelist<tmpl::transform<fluxes_args_boundary_faces_tags,
                                      tmpl::bind<db::item_type, tmpl::_1>>>
                  ...
                  for (const auto& neighbor_id : neighbors) {
                    ...
                    const auto intruding_extents =
                        LinearSolver::Schwarz::overlap_extents(
                            neighbor.mesh.extents(), max_overlap,
                    ...
                    all_overlap_inertial_coords.emplace(
                        ...
                        LinearSolver::Schwarz::restrict_to_overlap(
                            ...
                            intruding_extents, direction_in_neighbor));
                  }
                }
