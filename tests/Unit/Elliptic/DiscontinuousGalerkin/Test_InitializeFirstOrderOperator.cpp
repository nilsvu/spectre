...
void check_compute_items(
  ...
  CHECK(tag_is_retrievable(::Tags::Flux<AuxiliaryFieldTag<Dim>,
                                        tmpl::size_t<Dim>, Frame::Inertial>{}));
  CHECK(tag_is_retrievable(
      ::Tags::div<
          ::Tags::Flux<ScalarFieldTag, tmpl::size_t<Dim>, Frame::Inertial>>{}));
  CHECK(tag_is_retrievable(
      ::Tags::div<::Tags::Flux<AuxiliaryFieldTag<Dim>, tmpl::size_t<Dim>,
                               Frame::Inertial>>{}));
  CHECK(tag_is_retrievable(::Tags::Source<ScalarFieldTag>{}));
  CHECK(tag_is_retrievable(::Tags::Source<AuxiliaryFieldTag<Dim>>{}));
  // Items on internal interfaces
  CHECK(tag_is_retrievable(
  ...
  CHECK(tag_is_retrievable(
      domain::Tags::Interface<domain::Tags::InternalDirections<Dim>,
                              n_dot_fluxes_tag<Dim>>{}));
  // Items on interior boundaries
  CHECK(tag_is_retrievable(
