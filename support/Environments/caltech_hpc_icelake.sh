...
spectre_load_modules() {
    module use /central/groups/sxs/knelli/modules
    module load git/2.39.3-gcc-13.2.0-xop75ot
    ...
    module load libraries/libsharp/1.0.0-icelake
    module load libraries/libxsmm/1.16.1-avx2-icelake
    module load libraries/openblas/0.3.25-avx2
    module load libraries/fftw/3.3.10-icelake
    module load libraries/spec-exporter/2024-01-icelake
...
spectre_unload_modules() {
    module use /central/groups/sxs/knelli/modules
    module unload git/2.39.3-gcc-13.2.0-xop75ot
    ...
    module unload libraries/libsharp/1.0.0-icelake
    module unload libraries/libxsmm/1.16.1-avx2-icelake
    module unload libraries/openblas/0.3.25-avx2
    module unload libraries/fftw/3.3.10-icelake
    module unload libraries/spec-exporter/2024-01-icelake
