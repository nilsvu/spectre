...
struct compute_target_points_tags<
    ...
    std::void_t<typename InterpolationTargetTag::compute_target_points>,
    std::bool_constant<
        not has_empty_initialization_tags_v<InterpolationTargetTag>>> {
  using simple_tags =
...
struct InitializeInterpolationTarget {
  ...
  static auto apply(db::DataBox<DbTagsList>& box,
    ...
    initialize_interpolation_target_detail::make_initial_box<
