...
struct InitializeResidualMagnitude {
 ...
 public:
  ...
  static void apply(db::DataBox<DbTagsList>& box,
    ...
    db::mutate<LinearSolver::Tags::IterationId, residual_magnitude_tag,
        ...
        [residual_magnitude](
          ...
          *local_residual_magnitude = *initial_residual_magnitude =
              residual_magnitude;
          // Also setting this so re-initialization works. Perhaps we can
          // build this into `InitializeResidualMonitor instead.
          *iteration_id = 0;
    ...
    // Determine whether the linear solver has already converged. This
    // invokes the compute item.
 ...
 public:
  template <typename ParallelComponent, typename DbTagsList,
            ...
            Requires<tmpl::list_contains_v<
                DbTagsList, orthogonalization_history_tag>> = nullptr>
  static void apply(db::DataBox<DbTagsList>& box,
                    Parallel::ConstGlobalCache<Metavariables>& cache,
                    const ArrayIndex& /*array_index*/,
