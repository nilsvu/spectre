 ...
 * is used in the BinaryCompactObjectDomain, where two equiangular maps around
 ...
 *
 * The full map is obtained by replacing setting
 ...
 * lower half of the equiangular map when equal to -1, and to the upper half of
 * the equiangular map when equal to +1. It is given by:
 *
