...
class BinaryCompactObject : public DomainCreator<3> {
 public:
  ...
  /// Options for one of the two object in the binary domain
  struct Object {
    double inner_radius;
    double outer_radius;
    double x_coord;
  ...
  template <bool UseBoundaryConditions, typename BoundaryConditionsBase>
  struct ObjectFromOptions : Object {
    ...
    struct Interior {
      ...
      static constexpr Options::String help = {
          "Specify a boundary condition to excise Layer 0, leaving a "
          "spherical hole in its absence. Set to 'Auto' to fill the interior."};
    };
    ...
    using options = tmpl::list<
        ...
        tmpl::conditional_t<UseBoundaryConditions, Interior, ExciseInterior>,
        UseLogarithmicMap, AdditionToRadialRefinementLevel>;
    ObjectFromOptions() = default;
    ObjectFromOptions(
        double local_inner_radius, double local_outer_radius,
        double local_x_coord,
        std::optional<
            std::unique_ptr<domain::BoundaryConditions::BoundaryCondition>>
            local_inner_boundary_condition,
        bool local_use_logarithmic_map,
        size_t local_addition_to_radial_refinement_level) noexcept
        : Object{local_inner_radius,
                 local_outer_radius,
                 local_x_coord,
                 std::move(local_inner_boundary_condition),
                 local_use_logarithmic_map,
                 local_addition_to_radial_refinement_level} {}
    ObjectFromOptions(double local_inner_radius, double local_outer_radius,
  ...
  struct ObjectA {
    using type =
        ObjectFromOptions<UseBoundaryConditions, BoundaryConditionsBase>;
    static constexpr Options::String help = {
  ...
  using options = tmpl::append<
      tmpl::list<
          ObjectA<domain::BoundaryConditions::has_boundary_conditions_base_v<
                      typename Metavariables::system>,
                  domain::BoundaryConditions::get_boundary_conditions_base<
                      typename Metavariables::system>>,
          ObjectB<domain::BoundaryConditions::has_boundary_conditions_base_v<
                      typename Metavariables::system>,
                  domain::BoundaryConditions::get_boundary_conditions_base<
                      typename Metavariables::system>>,
          RadiusEnvelopingCube, RadiusOuterSphere, InitialRefinement,
          InitialGridPoints, UseProjectiveMap,
