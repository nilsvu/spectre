...
class BinaryCompactObject : public DomainCreator<3> {
 public:
  ...
  struct InnerRadiusOuterShell {
    using group = OuterShell;
    static std::string name() noexcept { return "InnerRadius"; }
  ...
  struct RadialDistributionOuterShell {
    using group = OuterShell;
    static std::string name() noexcept { return "RadialDistribution"; }
  ...
  using time_independent_options = tmpl::append<
      tmpl::list<ObjectA, ObjectB, RadiusEnvelopingCube, OuterRadius,
                 ...
                 RadialDistributionOuterShell, InnerRadiusOuterShell>,
      tmpl::conditional_t<
          domain::BoundaryConditions::has_boundary_conditions_base_v<
              typename Metavariables::system>,
  ...
  BinaryCompactObject(
      ...
      std::optional<double> inner_radius_outer_shell = std::nullopt,
      std::unique_ptr<domain::BoundaryConditions::BoundaryCondition>
 ...
 private:
  ...
  double inner_radius_outer_shell_{};
