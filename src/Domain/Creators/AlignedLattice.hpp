...
class AlignedLattice : public DomainCreator<VolumeDim> {
 public:
  ...
  struct BoundaryCondition {
    ...
    static constexpr Options::String help =
        "The boundary condition to impose on the outer sides.";
    using type = std::unique_ptr<BoundaryConditionsBase>;
  };
  template <typename BoundaryConditionsBase>
  struct InnerBoundaryCondition {
    static std::string name() { return "InnerBoundaryCondition"; }
    static constexpr Options::String help =
        "The boundary condition to impose on the inner sides (when blocks are "
        "exluded).";
 ...
 private:
  ...
  std::unique_ptr<domain::BoundaryConditions::BoundaryCondition>
      boundary_condition_{};
  std::optional<std::unique_ptr<domain::BoundaryConditions::BoundaryCondition>>
