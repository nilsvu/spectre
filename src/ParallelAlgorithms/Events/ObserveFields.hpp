...
class ObserveFields<VolumeDim, ObservationValueTag, tmpl::list<Tensors...>,
 ...
 public:
  ...
  void operator()(
    ...
    call_operator_impl(subfile_path_ + observation_key_suffix.value_or("none"),
                       variables_to_observe_, interpolation_mesh_,
                       observation_value, mesh, inertial_coordinates,
                       analytic_solution_tensors..., non_solution_tensors...,
                       optional_analytic_solutions, cache, array_index,
                       component);
  }
