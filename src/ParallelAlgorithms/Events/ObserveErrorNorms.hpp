...
class ObserveErrorNorms<ObservationValueTag, tmpl::list<Tensors...>,
 ...
 public:
  ...
  void operator()(const typename ObservationValueTag::type& observation_value,
    ...
    this->operator()(observation_value, observation_key_suffix, tensors...,
  ...
  void operator()(
      ...
      const ArrayIndex& array_index,
      const ParallelComponent* const meta) const noexcept {
    (*this)(observation_value, std::make_optional(""), tensors...,
            analytic_solutions, cache, array_index, meta);
  }
