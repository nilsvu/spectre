 ...
 *
 * Nonlinear solves of well-posed problems should never hit this limit.
 */
template <typename OptionsGroup>
struct MaxGlobalizationSteps {
  ...
  static type default_value() noexcept { return 40; }
  using group = OptionsGroup;
};
 ...
 *
 * Instead of taking full-length nonlinear solver steps when corrrecting the
