...
struct PrepareSolve {
 ...
 public:
  ...
  static std::tuple<db::DataBox<DbTagsList>&&> apply(
    ...
    db::mutate<Parallel::Tags::IterationId<OptionsGroup>, operand_tag,
               residual_tag>(
        make_not_null(&box),
...
struct InitializeHasConverged {
  ...
  static bool is_ready(const db::DataBox<DbTags>& box,
    ...
    return inbox.find(db::get<Parallel::Tags::IterationId<OptionsGroup>>(
               box)) != inbox.end();
  }
  ...
  static std::tuple<db::DataBox<DbTagsList>&&, bool, size_t> apply(
    ...
    auto has_converged = std::move(
        tuples::get<Tags::InitialHasConverged<OptionsGroup>>(inboxes)
            .extract(db::get<Parallel::Tags::IterationId<OptionsGroup>>(box))
            .mapped());

    db::mutate<Parallel::Tags::HasConverged<OptionsGroup>>(
        make_not_null(&box),
  ...
  static std::tuple<db::DataBox<DbTagsList>&&> apply(
    ...
    Parallel::contribute_to_reduction<
        ...
        Parallel::ReductionData<
            ...
            Parallel::ReductionDatum<double, funcl::Plus<>>>{
            get<Parallel::Tags::IterationId<OptionsGroup>>(box),
...
struct UpdateOperand {
 ...
 public:
  ...
  static std::tuple<db::DataBox<DbTagsList>&&, bool, size_t> apply(
    ...
    db::mutate<operand_tag, Parallel::Tags::IterationId<OptionsGroup>,
               Parallel::Tags::HasConverged<OptionsGroup>>(
        make_not_null(&box),
