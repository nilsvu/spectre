 ...
 public:
  ...
  using simple_tags =
      tmpl::list<Tags::IntrudingExtents<Dim, OptionsGroup>,
                 Tags::IntrudingOverlapWidths<Dim, OptionsGroup>,
  ...
  static auto apply(db::DataBox<DbTagsList>& box,
    ...
    Initialization::mutate_assign<simple_tags>(
        ...
        std::move(intruding_overlap_widths), std::move(element_weight),
        std::move(intruding_overlap_weights),
