...
std::tuple<double, double, std::array<double, 2>> solve_force_balance(
  ...
  Parallel::printf("conformal_factor_pow_4: %s\n", conformal_factor_pow_4);
  Parallel::printf("lapse: %s\n", lapse);
  Parallel::printf("shift_square: %s\n", shift_square);
  Parallel::printf("shift_y: %s\n", shift_y);
  ...
  // const std::array<double, 2> center_of_mass_and_angular_velocity{{0.,
  // 0.}};
  ...
  Parallel::printf("injection_energy: %s\n", injection_energy);
