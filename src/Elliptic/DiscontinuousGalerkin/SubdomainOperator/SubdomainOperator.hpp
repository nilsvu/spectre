 ...
 public:
  ...
  void operator()(
    ...
    const auto& [domain, central_element, central_mortar_meshes,
                 ...
                 all_neighbor_meshes, all_neighbor_face_normal_magnitudes,
    ...
    // linearity.
    const auto check_data_is_zero = [](const Variables<OperandTags>& data) {
      return alg::all_of(data, [](const double value) { return value == 0.; });
    };
