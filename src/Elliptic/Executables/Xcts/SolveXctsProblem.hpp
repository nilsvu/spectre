...
struct Metavariables {
  ...
  using normal_dot_numerical_flux_tag =
      Elliptic::OptionTags::NumericalFlux<Xcts::FirstOrderInternalPenaltyFlux<
          Dim,
          LinearSolver::Tags::Operand<NonlinearSolver::Tags::Correction<
              Xcts::Tags::ConformalFactor<DataVector>>>,
          LinearSolver::Tags::Operand<NonlinearSolver::Tags::Correction<
              Xcts::Tags::ConformalFactorGradient<Dim, Frame::Inertial,
                                                  DataVector>>>>>;
  using nonlinear_normal_dot_numerical_flux_tag =
      Elliptic::OptionTags::CorrectionNumericalFlux<
          Xcts::FirstOrderInternalPenaltyFlux<
              Dim, Xcts::Tags::ConformalFactor<DataVector>,
              Xcts::Tags::ConformalFactorGradient<Dim, Frame::Inertial,
                                                  DataVector>>>;
