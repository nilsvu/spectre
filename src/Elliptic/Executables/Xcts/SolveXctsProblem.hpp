...
struct Metavariables {
  ...
  using communicated_overlap_tags = tmpl::flatten<tmpl::list<
      // For computing the linearized sources on overlaps
      typename system::fields_tag,
      db::add_tag_prefix<::Tags::Flux, typename system::fields_tag,
  ...
  using nonlinear_boundary_scheme = dg::FirstOrderScheme::FirstOrderScheme<
      volume_dim, nonlinear_operand_tag,
      db::add_tag_prefix<NonlinearSolver::Tags::OperatorAppliedTo,
                         nonlinear_operand_tag>,
      normal_dot_numerical_flux, nonlinear_solver_iteration_id,
      massive_operator>;
  using boundary_scheme = dg::FirstOrderScheme::FirstOrderScheme<
      volume_dim, linear_operand_tag,
      db::add_tag_prefix<LinearSolver::Tags::OperatorAppliedTo,
                         linear_operand_tag>,
      linear_normal_dot_numerical_flux, combined_iteration_id,
      massive_operator>;
  ...
  using initialization_actions = tmpl::list<
      ...
      dg::Actions::InitializeInterfaces<
          ...
          dg::Initialization::slice_tags_to_exterior<
              ::Tags::Variables<typename system::background_fields>,
              // For linearized boundary conditions. The n.F are sliced to
              // exterior faces by `ImposeBoundaryConditions`.
              typename system::fields_tag>,
      ...
      elliptic::dg::Actions::InitializeSubdomain<
          ...
          communicated_overlap_tags, typename system::inv_metric_tag>,
