...
struct Metavariables {
  ...
  using initialization_actions = tmpl::list<
      ...
      ::Initialization::Actions::AddComputeTags<tmpl::list<
          // For boundary conditions
          domain::Tags::Slice<
              domain::Tags::BoundaryDirectionsInterior<volume_dim>, fields_tag>,
          domain::Tags::Slice<
              domain::Tags::BoundaryDirectionsInterior<volume_dim>, fluxes_tag>,
          domain::Tags::InterfaceCompute<
              domain::Tags::BoundaryDirectionsInterior<volume_dim>,
              ::Tags::NormalDotFluxCompute2<fields_tag, fluxes_tag, volume_dim,
                                            Frame::Inertial>>>>,
          ...
          tmpl::list<
              ...
              typename linear_solver::template solve<tmpl::list<
                  ...
                  /*, LinearSolver::Actions::MakeIdentityIfSkipped<multigrid>
                    // Only needed when preconditioner is skipped
