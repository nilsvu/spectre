...
struct Metavariables {
  ...
  using linear_solver = LinearSolver::gmres::Gmres<
      ...
      SolvePoisson::OptionTags::GmresGroup, true,
  ...
  using multigrid = LinearSolver::multigrid::Multigrid<
      ...
      SolvePoisson::OptionTags::MultigridGroup,
  ...
  using combined_iteration_id =
      SolvePoisson::CombinedIterationId<linear_solver_iteration_id,
