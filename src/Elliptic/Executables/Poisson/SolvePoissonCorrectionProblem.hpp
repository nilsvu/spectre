...
struct Metavariables {
  ...
  using system = Poisson::FirstOrderCorrectionSystem<Dim>;
  ...
  using normal_dot_numerical_flux_tag = Elliptic::OptionTags::NumericalFlux<
      Poisson::FirstOrderCorrectionInternalPenaltyFlux<
          Dim,
          ...
          LinearSolver::Tags::Operand<NonlinearSolver::Tags::Correction<
              Poisson::AuxiliaryField<Dim>>>>>;
  using nonlinear_normal_dot_numerical_flux_tag =
      Elliptic::OptionTags::CorrectionNumericalFlux<
          Poisson::FirstOrderCorrectionInternalPenaltyFlux<
              Dim, Poisson::Field, Poisson::AuxiliaryField<Dim>>>;
  ...
  using observed_reduction_data_tags = observers::collect_reduction_data_tags<
      tmpl::list<Poisson::Actions::Observe, linear_solver, nonlinear_solver>>;
