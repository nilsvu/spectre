...
struct Metavariables {
  ...
  using nonlinear_numerical_flux =
      dg::NumericalFluxes::FirstOrderInternalPenalty<
          Dim, tmpl::list<Poisson::Field>,
          tmpl::list<Poisson::AuxiliaryField<Dim>>>;
  ...
  using linear_numerical_flux = dg::NumericalFluxes::FirstOrderInternalPenalty<
      ...
      tmpl::list<LinearSolver::Tags::Operand<
          NonlinearSolver::Tags::Correction<Poisson::AuxiliaryField<Dim>>>>>;
  ...
  using const_global_cache_tag_list = tmpl::list<
      OptionTags::NumericalFlux<linear_numerical_flux>,
