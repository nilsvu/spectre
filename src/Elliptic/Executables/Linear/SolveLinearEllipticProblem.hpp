...
struct Metavariables {
  ...
  // All boundary conditions are analytic solutions right now, so we don't need
  // to check anything. This will be generalized ASAP to handle analytic data
  // and numeric initial guesses.
  using analytic_solution = Poisson::Solutions::Solution<
      volume_dim, tmpl::list<Poisson::Solutions::Registrars::ProductOfSinusoids<
                      volume_dim>>>;
...
static const std::vector<void (*)()> charm_init_node_funcs{
    ...
    &Parallel::register_derived_classes_with_charm<
        metavariables::analytic_solution>,
    &Parallel::register_derived_classes_with_charm<
