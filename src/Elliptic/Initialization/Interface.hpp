...
struct Interface {
  ...
  using face_tags = tmpl::list<
      ...
      // TODO: switch off for linear solves
      ::Tags::Slice<Directions, typename System::nonlinear_fields_tag>,
      ::Tags::Slice<
          Directions,
          db::add_tag_prefix<::Tags::deriv,
                             db::variables_tag_with_tags_list<
                                 typename System::nonlinear_fields_tag,
                                 typename System::nonlinear_gradient_tags>,
                             tmpl::size_t<volume_dim>, Frame::Inertial>>,
  ...
  static auto initialize(db::DataBox<TagsList>&& box) noexcept {
    ...
    std::unordered_map<Direction<volume_dim>,
                       db::item_type<typename System::nonlinear_fields_tag>>
        external_boundary_nonlinear_vars{};
    ...
    for (const auto& direction :
      ...
      external_boundary_nonlinear_vars[direction] =
          db::item_type<typename System::nonlinear_fields_tag>{
              mesh.slice_away(direction.dimension()).number_of_grid_points()};
    }
    ...
    return db::create_from<db::RemoveTags<>, simple_tags, compute_tags>(
        ...
        std::move(external_boundary_nonlinear_vars));
  }
};
