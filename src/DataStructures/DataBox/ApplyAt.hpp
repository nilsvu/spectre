...
SPECTRE_ALWAYS_INLINE auto apply_at(F&& f, const DataBox<BoxTags>& box,
                                    const std::tuple<MapKeys...>& map_keys,
                                    tmpl::list<ArgumentTags...> /*meta*/,
                                    PassthroughArgumentTags /*meta*/,
                                    Args&&... args) noexcept {
  return ::db::apply<tmpl::list<ArgumentTags...>>(
...
SPECTRE_ALWAYS_INLINE void mutate_apply_at(
    ...
    Args&&... args) noexcept {
  ::db::mutate_apply<tmpl::list<ReturnTags...>, tmpl::list<ArgumentTags...>>(
      [&f, &map_keys, &args...](
