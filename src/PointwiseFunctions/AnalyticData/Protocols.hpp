 ...
 * \brief A analytic initial data to a system of evolution equations.
 *
 ...
 * tags that is supplied as the third `meta` argument. When multiple variables
 * are requested, this function should make sure that precomputed data is shared
 ...
 private:
  ...
  struct IsVariablesCallable
      : is_variables_callable_r_t<
            ...
            tnsr::I<DataVector, ConformingType::volume_dim>, tmpl::list<>> {};
