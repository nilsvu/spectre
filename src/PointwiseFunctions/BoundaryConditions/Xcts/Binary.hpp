...
template <typename Component, bool IsLinearization>
typename Binary<Component, IsLinearization>::Linearization
Binary<Component, IsLinearization>::linearization() const noexcept {
  return Linearization{
      positions_,
      {{components_[0].linearization(), components_[1].linearization()}}};
};
