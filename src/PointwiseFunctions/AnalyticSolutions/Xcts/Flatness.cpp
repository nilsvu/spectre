...
Flatness::variables(const tnsr::I<DataType, 3>& x,
...
template <typename DataType>
tuples::TaggedTuple<gr::Tags::EnergyDensity<DataType>> Flatness::variables(
    const tnsr::I<DataType, 3>& x,
...
template <typename DataType>
tuples::TaggedTuple<gr::Tags::StressTrace<DataType>> Flatness::variables(
    const tnsr::I<DataType, 3>& x,
...
#define INSTANTIATE_VARS(_, data)                                              \
  ...
  Flatness::variables(const tnsr::I<DTYPE(data), 3>& x,                        \
                      tmpl::list<::Tags::FixedSource<                          \
